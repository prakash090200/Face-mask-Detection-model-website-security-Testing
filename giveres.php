...
while($row=mysqli_fetch_array($check)){
	echo "<tr><td><form method='POST' action='c5.php'><input type='radio' name='rad' value='$row[2]'>$row[2]</td><td>".$row[0]." ".$row[1]."</td><td><input type='text' name='at' ></td><td><input type='text' name='mk' ></td><td><input type='submit' value='upload'></td></form></tr>";
}
echo"</table>";
?>
</div><br><br>
